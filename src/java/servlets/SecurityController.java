    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (path) {
            ...
            case "/login":
                ...
                request.setAttribute("info","Role: "+regUser.getLogin());
            ...
            case "/registration":
                ...
                Customer customer = new Customer( name,surname,email,city,new Integer(cash));
                customerFacade.create(customer);
                encription = new Encription();
                encriptPassword = encription.getEncriptionPass(password1);
                User user = new User(login, encriptPassword, true, customer);
